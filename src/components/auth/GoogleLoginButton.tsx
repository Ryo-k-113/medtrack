...
import { getCurrentPathForRedirect } from "@/hooks/useAuthNavigation"
...
export const GoogleLoginButton = ({
  ...
  const signInWithGoogle = () => {
    const redirectTo = redirectToCurrentPage
  ...
  return (
    <Button
      ...
      className={cn("h-12 w-full rounded-full hover:bg-surface", className)}
    >
