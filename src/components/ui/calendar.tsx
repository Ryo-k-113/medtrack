    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-8 select-none p-0 hover:bg-surface hover:text-foreground aria-disabled:opacity-50",
